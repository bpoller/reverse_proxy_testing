 ...
 */
public class MyDockerClientImpl implements Closeable, DockerClient {

    private final DockerClientConfig dockerClientConfig;

    private MyDockerCmdExecFactory dockerCmdExecFactory;

    private MyDockerClientImpl() {
        this(DockerClientConfig.createDefaultConfigBuilder().build());
    }

    private MyDockerClientImpl(String serverUrl) {
        this(configWithServerUrl(serverUrl));
    }

    private MyDockerClientImpl(DockerClientConfig dockerClientConfig) {
    ...
    public static MyDockerClientImpl getInstance() {
        return new MyDockerClientImpl();
    }

    public static MyDockerClientImpl getInstance(DockerClientConfig dockerClientConfig) {
        return new MyDockerClientImpl(dockerClientConfig);
    }

    public static MyDockerClientImpl getInstance(String serverUrl) {
        return new MyDockerClientImpl(serverUrl);
    }

    public MyDockerClientImpl withDockerCmdExecFactory(MyDockerCmdExecFactory dockerCmdExecFactory) {
    ...
    private MyDockerCmdExecFactory getDockerCmdExecFactory() {
        checkNotNull(dockerCmdExecFactory, "dockerCmdExecFactory was not specified");
